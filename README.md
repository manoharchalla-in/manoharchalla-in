...
I'm **Challa Manohar**, an **AI-Full Stack Developer** pursuing **B.Tech in Computer Science & Engineering (Artificial Intelligence)**, passionate about building modern, AI-powered web applications that solve real-world problems.

I work with **React.js, Node.js, Firebase, REST APIs**, and AI technologies to create scalable, responsive, and user-focused applications — and I enjoy picking up new tools along the way.
...
- 🏆 CodeChef: [cit_23ht1a4315](https://www.codechef.com/users/cit_23ht1a4315)
- 📄 Resume: [View here](https://drive.google.com/file/d/17QwRfFf8-jzomB7fnvqKFlHCxw-UJQ3Y/view?usp=sharing)
- 📫 Reach me at **challamanoharmanu@gmail.com**
...
<sub>⚠️ The snake activates automatically once you add the <code>.github/workflows/snake.yml</code> workflow and run it once.</sub>
